...
async def run_collector():
    ...
    severe_volcanoes = [
        ...
        {
            "title": "Mount Sinabung — North Sumatra, Indonesia",
            "category": "Explosive Volcanic Eruption & Pyroclastic Flow",
            "severity": "RED ALERT (LEVEL III)",
            "level": "escalate",
            "summary": "Persistent dome instability resulting in high-altitude ash columns and high-velocity pyroclastic flows sweeping down eastern valleys.",
            "latitude": 3.170,
            "longitude": 98.392,
            "time": datetime.now(timezone.utc).isoformat(),
            "details": {
                "last_eruptive_cycle": "Active Phase 2026",
                "damage_scope": "Extensive agricultural ash burial across Karo plateau horticultural districts.",
                "population_affected": "~300,000 regional flank residents",
                "warnings": "Strict exclusion zones within 3-5 km of summit crater and southeastern sectors.",
                "aftermath_warnings": "Lahars and secondary mudflows during heavy precipitation events.",
                "technical_insights": "Viscous dacitic magma extrusion pressurizing the summit dome, leading to episodic gravity collapses."
            }
        },
        {
        ...
        {
            "title": "Mount Marapi — West Sumatra, Indonesia",
            "category": "Strombolian Explosion & Ash Plume",
            "severity": "ELEVATED ALERT (LEVEL III)",
            "level": "alert",
            "summary": "Sudden ash explosions rising 2-3 km above summit crater, impacting air quality across Padang Panjang and Bukittinggi.",
            "latitude": -0.381,
            "longitude": 100.473,
            "time": datetime.now(timezone.utc).isoformat(),
            "details": {
                "last_eruptive_cycle": "Active Intermittent Phase 2026",
                "damage_scope": "Minor infrastructural ash coating and vegetable crop yield reductions in upper slopes.",
                "population_affected": "~280,000 surrounding highland residents",
                "warnings": "3 km radius exclusion zone from Verbeek crater.",
                "aftermath_warnings": "Sulphur dioxide gas dispersion hazards and rain-induced lahar paths.",
                "technical_insights": "Shallow hydrothermal-phreatic mixing pressurizing upper conduit channels."
            }
        },
        {
